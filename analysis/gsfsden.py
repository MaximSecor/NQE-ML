...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan  4 11:38:21 2021
...
features = np.concatenate((target_wave[:,:,0]**2,target_wave[:,:,1]**2),1)
...
model = load_model(directory_loc + 'ANN_1DTISE/gsfsden_PES/saved_model')
